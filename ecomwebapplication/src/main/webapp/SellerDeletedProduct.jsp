...
<head>
    ...
    <title>Seller Deleted Products</title>
...
<div class="container mt-5">
    <h1 class="mt-4">Your Deleted Products</h1>
    <%
        ...
        List<Product> products = productDAO.getDeletedProductsForUser(userId);
    %>
    <% if (products.isEmpty()) { %>
        <p>You have no products deleted before</p>
    <% } else { %>
        <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="undeleteProduct" method="POST">
                                <input type="hidden" name="productId" value="<%= product.getProductId() %>">
                                <button class="btn btn-danger" type="submit" name="addItAgainProduct">Add It Again</button>
                            </form>
                        </div>
                    </div>
                </div>
